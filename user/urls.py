...
urlpatterns = [
    ...
    path('municipality-level/', login_required(MunicipalLevelListView.as_view()), name='municipal_level_list'),
    path('municipality-level/create/', login_required(MunicipalLevelCreateView.as_view()), name='municipal_level_create'),

    path('municipality-level/update/<int:pk>/', login_required(MunicipalLevelUpdateView.as_view()), name='municipal_level_update'),
    ...
    path('parish-level/update/<int:pk>/', login_required(ParishLevelUpdateView.as_view()), name='parish_level_update'),
    path('communal-council-level/', login_required(CommunalCouncilLevelListView.as_view()), name='communal_council_level_list'),
    path('communal-council-level/create/', login_required(CommunalCouncilLevelCreateView.as_view()), name='communal_council_level_create'),
